...
const PaymentRow = ({payment, group}: {
  ...
  const paidFrom = getGroupMemberDisplayNameFromMembershipId(group, payment.paid_from)
  const paidTo = getGroupMemberDisplayNameFromMembershipId(group, payment.paid_to)
